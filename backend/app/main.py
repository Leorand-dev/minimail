...
from app.api import contacts, api_tokens, email_accounts, auto_detect, files, memos, search, shares, system_docs, mail_batch
...
app.include_router(mail_batch.router, tags=["mail-batch"])
